import Hero from "@/components/Order/Order-list";

import { Footer, Header } from "@/components/Layouts";
import { Locale } from "@/i18n-config";
import { getDictionary } from "@/get-dictionary";

const OrderListPage = async (props: { params: Promise<{ lang: Locale }> }) => {
  ...
  return (
    <>
      ...
      {/* <div className="sticky top-0 z-50 w-full bg-blue-600 text-white py-4 px-6 shadow-md">
        ...
        <div id="OrderListHero" className="w-full bg-[#fff4e33d]">
