      ...
      <div className="flex justify-start items-center mt-[44px] 2xl:mt-[120px] xl:mt-[120px] lg:mt-[120px] md:mt-[120px]">
        <div className="w-full grid grid-cols-1 px-5 2xl:px-0 xl:px-0 lg:px-0 md:px-0">
            <div className="w-full">
                <h1 className="text-[#22304A] text-center font-[900] text-[44px] 2xl:text-[44px] xl:text-[44px] lg:text-[44px] md:text-[44px] leading-[59.8px] 2xl:leading-[70.2px] xl:leading-[70.2px] lg:leading-[70.2px] md:leading-[70.2px] tracking-[-1px]"> 
                  <span className={lang === 'bn' ? 'font-noto-sans-regular' : 'font-mikado'}>{dictionary.AboutKiddoz.title}</span>
                </h1>
            </div>
        </div>
      </div>
