<header id="topbar"
    ...
    <div class="flex items-center space-x-3">
        ...
        <h1 class="text-lg font-semibold"><?php echo $__env->yieldContent('page_title', 'Dashboard'); ?></h1>
    </div>

    <div class="flex items-center gap-4">
        <span class="text-sm text-gray-600"><?php echo e(auth()->user()->name ?? 'Admin'); ?></span>
        <button class="px-3 py-1 text-sm bg-gray-900 text-white rounded-lg">
            Logout
        </button>
    </div>
</header>
<?php /**PATH H:\xampp\htdocs\courier-service\backend\resources\views/partials/topbar.blade.php ENDPATH**/ ?>